...
public class TestEditorPredictivo extends JFrame implements ActionListener, 
       javax.swing.event.CaretListener, java.awt.event.MouseListener,
       java.awt.event.MouseMotionListener {

	private static final long serialVersionUID = 1L;
	
	private static final String DICCIONARIO_POR_DEFECTO = "castellano.txt";
    ...
    public static void main(String[] args) {
        TestEditorPredictivo app = new TestEditorPredictivo();
    ...
    private class JPanelRound extends JPanel {
         ...
         */
        public void setArcw(int aw) { this.arcw = aw; }
         ...
         */
        public void setArch(int ah) { this.arch = ah; }
    }
    ...
    private class JButtonRound extends JButton {
         ...
         * @param pY      Posición vertical del boton
         */
        public JButtonRound(String rotulo, int pY) { 
            super(rotulo);
            this.posY = pY;
            setFocusable(false);
